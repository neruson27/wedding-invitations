...
function GoogleMap({id, confirm}) {
  ...
  return (
    <div className="p-2 bg-purple-600 grid justify-center">
      ...
      {!confirm ? <button className="md:w-[10vw] m-1 justify-self-center bg-slate-100 hover:bg-slate-200 border-2 rounded-xl text-purple-600" onClick={fetchData}>Confirmar asistencia</button>:<></>}
    </div>
  )
}
